...
namespace ProyectoFinalCulebrita.Modificado
{
    ...
    public ColaCirc(Size tmPantalla, ColaCirc<Point> snk, Point pocisionInicio)
    {
        this.pantalla = tmPantalla;
        this.snake = snk;
        this.snake = new ColaCirc<Point>();
    ...
    public Point ObtieneSiguienteDireccion(Direction direction, Point currentPosition)
    {
        ...
        //ordena el objeto y representa de las coordenadas y la definen
        ...
        int longitudCulebra)
    {
       ...
       //  hace que la culebrita no salga de la pantalla y retorna el false
        ...
        //este metodo cuenta los datos que se van ingresando  en el array
